...
SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    timeDilation = 1;// esta variavel influencia na velocidade do app, quanto maior o numero mais lento fica
    return Scaffold(
      body: Container(
        ...
        child: ListView(
          ...
          children: <Widget>[
            Stack( // com este componente é possível colocar um componente em cima do outro
